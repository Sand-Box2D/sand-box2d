 ...
 * 
 * 6. Then, it will init it and rerun the check which window should execute "step".
 * 
 * 7. After doing so it will eventually render the new scene.
 * 
 ...
 * which is shown at the same time.
 * 
